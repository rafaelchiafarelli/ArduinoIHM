/***************************************************
  ...
  This is an example for how to use BusIO_RegisterBits from
 BusIO library.
...
SPIDevice spi_dev = SPIDevice(
    MAX31865_SPI_CS, MAX31865_SPI_SPEED, MAX31865_SPI_BITORDER,
    MAX31865_SPI_MODE, &SPI); // Hardware SPI
// SPIDevice spi_dev = SPIDevice( MAX31865_SPI_CS, 13, 12, 11,
// MAX31865_SPI_SPEED, MAX31865_SPI_BITORDER, MAX31865_SPI_MODE); // Software
// SPI

// MAX31865 chip related
// *********************************************************************************************
BusIO_Register config_reg =
    BusIO_Register(&spi_dev, 0x00, ADDRBIT8_HIGH_TOWRITE, 1, MSBFIRST);
BusIO_RegisterBits bias_bit =
    BusIO_RegisterBits(&config_reg, 1, 7);
BusIO_RegisterBits auto_bit =
    BusIO_RegisterBits(&config_reg, 1, 6);
BusIO_RegisterBits oneS_bit =
    BusIO_RegisterBits(&config_reg, 1, 5);
BusIO_RegisterBits wire_bit =
    BusIO_RegisterBits(&config_reg, 1, 4);
BusIO_RegisterBits faultT_bits =
    BusIO_RegisterBits(&config_reg, 2, 2);
BusIO_RegisterBits faultR_bit =
    BusIO_RegisterBits(&config_reg, 1, 1);
BusIO_RegisterBits fi50hz_bit =
    BusIO_RegisterBits(&config_reg, 1, 0);

BusIO_Register rRatio_reg =
    BusIO_Register(&spi_dev, 0x01, ADDRBIT8_HIGH_TOWRITE, 2, MSBFIRST);
BusIO_RegisterBits rRatio_bits =
    BusIO_RegisterBits(&rRatio_reg, 15, 1);
BusIO_RegisterBits fault_bit =
    BusIO_RegisterBits(&rRatio_reg, 1, 0);

BusIO_Register maxRratio_reg =
    BusIO_Register(&spi_dev, 0x03, ADDRBIT8_HIGH_TOWRITE, 2, MSBFIRST);
BusIO_RegisterBits maxRratio_bits =
    BusIO_RegisterBits(&maxRratio_reg, 15, 1);

BusIO_Register minRratio_reg =
    BusIO_Register(&spi_dev, 0x05, ADDRBIT8_HIGH_TOWRITE, 2, MSBFIRST);
BusIO_RegisterBits minRratio_bits =
    BusIO_RegisterBits(&minRratio_reg, 15, 1);

BusIO_Register fault_reg =
    BusIO_Register(&spi_dev, 0x07, ADDRBIT8_HIGH_TOWRITE, 1, MSBFIRST);
BusIO_RegisterBits range_high_fault_bit =
    BusIO_RegisterBits(&fault_reg, 1, 7);
BusIO_RegisterBits range_low_fault_bit =
    BusIO_RegisterBits(&fault_reg, 1, 6);
BusIO_RegisterBits refin_high_fault_bit =
    BusIO_RegisterBits(&fault_reg, 1, 5);
BusIO_RegisterBits refin_low_fault_bit =
    BusIO_RegisterBits(&fault_reg, 1, 4);
BusIO_RegisterBits rtdin_low_fault_bit =
    BusIO_RegisterBits(&fault_reg, 1, 3);
BusIO_RegisterBits voltage_fault_bit =
    BusIO_RegisterBits(&fault_reg, 1, 2);
...
void setup() {
  ...
  Serial.begin(115200);
  Serial.println("SPI BusIO_RegisterBits test on MAX31865");
