...
public:
  ...
  GenericDevice *createDevice() {
    return new GenericDevice(this, uart_read, uart_write, uart_readreg,
                                      uart_writereg);
  }
};
...
void setup() {
  ...
  GenericDevice *device = uart.createDevice();
  device->begin();

  // Create register object for IOIN
  BusIO_Register ioin_reg(device,
  ...
  BusIO_RegisterBits version_bits(
