MCP4725 [![Build Status](https://github.com/adafruit/MCP4725/workflows/Arduino%20Library%20CI/badge.svg)](https://github.com/adafruit/MCP4725/actions)
================
...
Place the MCP4725 library folder your arduinosketchfolder/libraries/ folder. You may need to create the libraries subfolder if its your first library. Restart the IDE.
