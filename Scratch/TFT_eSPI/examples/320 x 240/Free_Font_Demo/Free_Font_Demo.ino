/*
  This example draws fonts (as used by the GFX library) onto the
...
void loop() {
  ...
  // For comaptibility with GFX library the text background is not plotted when using the print class
