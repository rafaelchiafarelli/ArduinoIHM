...
The Button class from GFX is incorporated, with the enhancement that the button labels can be in any font.
...
Here is the GFX "FreeSans12pt" bitmap font compared to the same font drawn as anti-aliased:
...
https://github.com/s60sc/TouchScreen
