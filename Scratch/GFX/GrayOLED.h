...
*/
class GrayOLED : public GFX {
public:
  GrayOLED(uint8_t bpp, uint16_t w, uint16_t h, TwoWire *twi = &Wire,
                    int16_t rst_pin = -1, uint32_t preclk = 400000,
                    uint32_t postclk = 100000);
  GrayOLED(uint8_t bpp, uint16_t w, uint16_t h, int16_t mosi_pin,
                    int16_t sclk_pin, int16_t dc_pin, int16_t rst_pin,
                    int16_t cs_pin);
  GrayOLED(uint8_t bpp, uint16_t w, uint16_t h, SPIClass *spi,
...
protected:
  ...
  SPIDevice *spi_dev = NULL; ///< The SPI interface BusIO device
  I2CDevice *i2c_dev = NULL; ///< The I2C interface BusIO device
