/*
 * Display class inherits from GFX class and the Arduino Print class.
 * Any use of Display class and examples is dependent on Adafruit and Arduino licenses
...
class Display : public GFX {
	...
	public:
//	Display(int CS=A3, int RS=A2, int WR=A1, int RD=A0, int RST=A4); //shield wiring
	Display(int CS=0, int RS=0, int WR=0, int RD=0, int _RST=0);  //dummy arguments 
