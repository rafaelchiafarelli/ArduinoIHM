...
#define MAVLINK_IHM_DIALECT_XML_HASH 5915115374870298334
...
#define MAVLINK_MESSAGE_CRCS {{300, 157, 19, 19, 0, 0, 0}, {301, 176, 20, 20, 0, 0, 0}, {302, 161, 38, 38, 0, 0, 0}, {303, 93, 13, 13, 0, 0, 0}, {304, 163, 1, 1, 0, 0, 0}, {305, 19, 2, 2, 0, 0, 0}, {306, 133, 1, 1, 0, 0, 0}}
#endif
...
#include "./mavlink_msg_ihm_simulate_button.h"
...
# define MAVLINK_MESSAGE_NAMES {{ "CAN_SIGNAL_CONFIG", 301 }, { "IHM_BOARD_STATE", 300 }, { "IHM_RELAY_STATE", 304 }, { "IHM_SIMULATE_BUTTON", 306 }, { "IHM_SIMULATE_ENCODER", 305 }, { "PWM_CHANNEL_CONFIG", 303 }, { "RS485_SIGNAL_CONFIG", 302 }}
