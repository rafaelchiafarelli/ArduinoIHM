...
Timer0 is for time keeping and fast-handler operations (communications, debug and others)
Timer2 is used for Servo control and DC motor (both as DC and stepper) as a time keeper and output control.
